...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/hts-central/vercel-v2&project-name=cms-wordpress&repository-name=cms-wordpress&env=WORDPRESS_API_URL&envDescription=Required to connect the app with WordPress&envLink=https://vercel.link/cms-wordpress-env)
